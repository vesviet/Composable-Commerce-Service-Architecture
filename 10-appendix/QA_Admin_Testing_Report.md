...
- [Critical] [Admin - Customer] API 500 Error (List): `GET /admin/v1/customers` returns 500. Table shows "No data".
...
- [High] [Admin - Auth/Session] Frequent Logouts: Navigating between Orders and Fulfillments frequently triggers unwanted logouts and clears session state.
