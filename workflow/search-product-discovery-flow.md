...
## 10) Related Docs
- Search sellable view & warehouse strategy: [docs/workflow/search-sellable-view-per-warehouse-complete.md](search-sellable-view-per-warehouse-complete.md)
- Visibility filtering design: [docs/workflow/search-product-visibility-filtering.md](search-product-visibility-filtering.md)
- Issues checklist: [docs/workflow/checklists/search-catalog-product-discovery-flow-issues.md](checklists/search-catalog-product-discovery-flow-issues.md)
