...
Tax integration details are documented in [docs/workflow/tax_flow.md](tax_flow.md).
...
See [docs/workflow/tax_flow.md](tax_flow.md) for the verified current path and the recommended refactor (pass full context correctly).
```
...
## 8) Links
- Issues checklist: [docs/workflow/checklists/pricing-promotion-flow-issues.md](checklists/pricing-promotion-flow-issues.md)
- Pricing-only flow (text): [docs/workflow/PRICING_FLOW.md](PRICING_FLOW.md)
- Promotion-only flow (text): [docs/workflow/promotion_flow.md](promotion_flow.md)
- Tax flow: [docs/workflow/tax_flow.md](tax_flow.md)
- Search sellable view: [docs/workflow/search-sellable-view-per-warehouse-complete.md](search-sellable-view-per-warehouse-complete.md)
